<template>
  <div class="peace-layout" :style="{ minWidth: minWidth + 'px' }">
    ...
    <PeaceLayoutContent v-bind="commonProps" :padding-top="contentPaddingTop" :padding-bottom="contentPaddingBottom" :padding-left="siderWidth">
      <slot></slot>
    </PeaceLayoutContent>
    <PeaceLayoutFooter
      v-if="footerVisible"
...
import PeaceLayoutHeader from './components/PeaceLayoutHeader.vue'
import PeaceLayoutTab from './components/PeaceLayoutTab.vue'
import PeaceLayoutSider from './components/PeaceLayoutSider.vue'
import PeaceLayoutContent from './components/PeaceLayoutContent.vue'
import PeaceLayoutFooter from './components/PeaceLayoutFooter.vue'
